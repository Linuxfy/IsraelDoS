...
// Current version
define('DDOS_Creator',				'@Linuxfy' );
define('DFM_ID',						'@Lvel5' );

// MD5 Password to be used when the script is executed from the webserver, default is "opbedilreloaded"
define('DDOS_PASSWORD',				'6fa0963066bdc656e52f52ecbba1d5d3' );
...
class DDoS {
	...
	public function signature() {
		if(DDOS_OUTPUT_FORMAT_TEXT == $this->get_param('format')) {
			$this->println('#OpBedilReloaded');
			$this->println('Create by : '.DDOS_Creator);
			$this->println('DFM FORUM : '.DFM_ID);
			$this->println();
		}
	}
